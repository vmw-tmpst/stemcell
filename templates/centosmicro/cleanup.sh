...
rm -f _package_compiler.tar _release.tgz _release.yml
rm -f base.sh micro.sh sudo.sh setup-bosh.sh monit.sh ruby.sh bosh_agent.sh vmware-tools.sh harden.sh timestamp.sh postinstall.sh cleanup.sh zerodisk.sh
rm -f *.iso *.gem